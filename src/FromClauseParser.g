...
@after { gParent.msgs.pop(); }
    :
    identifier
    // { System.err.println("[TABLE_OR_COLUMN][" + $identifier.text + "]"); }
...
@after { gParent.msgs.pop(); }
    ...
    // { System.err.println("[TABLE_SOURCE][" + $tabname.text + "]"); }
...
@after { gParent.msgs.pop(); }
    ...
    // { System.err.println("[TABLE_NAME][" + $db.text + "." + $tab.text + "]"); }
    -> ^(TOK_TABNAME $db $tab)
    |
    tab=identifier
    // { System.err.println("[TABLE_NAME][" + $tab.text + "]"); }
    -> ^(TOK_TABNAME $tab)
    ;
